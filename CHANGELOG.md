...
### Added
- Contributor-facing repository support docs: roadmap, demo-assets guidance, and pull request template.
- Expanded contribution guidance with setup, reporting flow, etiquette, and review process.

### Changed
- Reorganized top-level README for clearer quick-start, audience targeting, PoC disclaimer, and navigation links.
- Refined issue templates for better reproducibility and expectation-setting.
