...
def compute_bearing_frequencies(
    ...
    Args:
        ...
        bearing_name: Optional bearing designation (e.g., "SKF 6205")
        
    Returns:
        BearingFrequencies with FTF, BPFO, BPFI, BSF values in Hz
    """
    f_shaft = rpm / 60.0  # Shaft frequency in Hz
...
# ---------------------------------------------------------------------------
# Common bearing database (a few examples)
# ---------------------------------------------------------------------------

COMMON_BEARINGS: dict[str, BearingGeometry] = {
    "6205": BearingGeometry(
        name="6205 (Deep groove)", n_balls=9, ball_dia=7.938, pitch_dia=38.5, contact_angle=0
    ),
    "6206": BearingGeometry(
        name="6206 (Deep groove)", n_balls=9, ball_dia=9.525, pitch_dia=46.0, contact_angle=0
    ),
    "6207": BearingGeometry(
        name="6207 (Deep groove)", n_balls=9, ball_dia=11.112, pitch_dia=53.5, contact_angle=0
    ),
    "6208": BearingGeometry(
        name="6208 (Deep groove)", n_balls=9, ball_dia=12.7, pitch_dia=60.0, contact_angle=0
    ),
    "6305": BearingGeometry(
        name="6305 (Deep groove)", n_balls=8, ball_dia=10.319, pitch_dia=39.04, contact_angle=0
    ),
    "6306": BearingGeometry(
        name="6306 (Deep groove)", n_balls=8, ball_dia=12.303, pitch_dia=46.36, contact_angle=0
    ),
    "NU205": BearingGeometry(
        name="NU205 (Cylindrical roller)", n_balls=13, ball_dia=7.5, pitch_dia=38.5, contact_angle=0
    ),
    "NU206": BearingGeometry(
        name="NU206 (Cylindrical roller)", n_balls=13, ball_dia=9.0, pitch_dia=46.0, contact_angle=0
    ),
    "7205": BearingGeometry(
        name="7205 (Angular contact)", n_balls=12, ball_dia=7.144, pitch_dia=38.0, contact_angle=25
    ),
}
